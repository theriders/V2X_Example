...
in the UDP packet. The current UDP packet has an ID for the vehicle, the ToF
distance, and the accelerometer measurement. On the other vehicle, this
...
\paragraph{Hardware issues} We are also going to add a paragraph for hardware
issues (reordering due to bad components, etc…) TODO
